...
class ValorInteresSimplePage extends StatefulWidget {
  const ValorInteresSimplePage({super.key});

  @override
  State<ValorInteresSimplePage> createState() => _ValorInteresSimplePageState();
}

class _ValorInteresSimplePageState extends State<ValorInteresSimplePage> {
  int anios = 0;
  int dias = 0;
  int meses = 0;
  double valorFinal = 0;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 40),
        Center(
            child: Text('Interés producido: \$$valorInteres',
  ...
  void calcularValorFinal(BuildContext context) {
    ...
    if (porcentaje != 0 && valorInicial != 0) {
      setState(() {
        ...
        valorInteres = double.parse(valorInteres.toStringAsFixed(2));
